...
<head>
    ...
    <title>NSBM Green University | Add Department</title>
                    ...
                    <a href="index.jsp" class="text-decoration-none university-brand">
                        ...
                        <div>
                            ...
                            <div class="d-flex align-items-center">
                                <p class="university-system">Administration Management System</p>
                    ...
                    <div class="col-md-8">
                        <div class="form-card">
                            <div class="form-header">
                                <h4><i class="fas fa-building me-2"></i> Add New Department</h4>
                            </div>
                            <div class="form-body">
                                <form action="AddDepartmentServlet" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="head" name="head" placeholder="Enter department head name" required>
                                    </div>
                                    ...
                                    <div class="d-flex justify-content-end gap-2 mt-4">
                                        <a href="departments.jsp" class="btn btn-outline-secondary">
