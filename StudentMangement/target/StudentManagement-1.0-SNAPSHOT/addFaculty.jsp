                    ...
                    <a href="index.jsp" class="text-decoration-none university-brand">
                        ...
                        <div>
                            ...
                            <div class="d-flex align-items-center">
                                <p class="university-system">Admin Management System</p>
            ...
            <div class="container">
                <div class="faculty-card">
                    <div class="faculty-header">
                        <h3><i class="fas fa-user-plus me-2"></i> Add New Faculty Member</h3>
                    </div>
                            ...
                            <div class="row g-4">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="facultyName" name="name" placeholder="Enter faculty member's full name" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 mt-4 d-flex justify-content-end gap-3">
                                    <a href="facultyList.jsp" class="btn btn-secondary">
