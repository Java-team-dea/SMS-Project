                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="status-badge 
                                                      ${attendance.attendanceStatus eq 'Present' ? 'status-present' : 
                                                        attendance.attendanceStatus eq 'Absent' ? 'status-absent' : 'status-late'}">
                                                ...
                                                <td>
                                                    ...
                                                    <a href="deleteAttendance?id=${attendance.studentId}" 
