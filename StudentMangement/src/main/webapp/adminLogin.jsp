...
<head>
    ...
    <title>Administrator Login - NSBM Green University</title>
...
<body>
            ...
            <a href="index.jsp" class="d-flex align-items-center text-decoration-none">
                ...
                <div class="ms-3">
                    ...
                    <div class="d-flex align-items-center mt-1">
                        ...
                        <span class="badge-admin ms-2">ADMIN PORTAL</span>
                    </div>
                </div>
            </a>
            <div>
    ...
    <div class="login-wrapper">
        <div class="login-container">
            <div class="login-header">
                ...
                <p class="text-muted small">Secure access to management dashboard</p>
            </div>
            ...
            <form action="AdminLoginServlet" method="post" class="needs-validation" novalidate>
                <div class="mb-4">
            ...
            <div class="text-center mt-4">
                ...
                <p class="small text-muted">
                    Having trouble? <a href="support.jsp" class="support-link">Contact IT Support</a>
                </p>
            </div>
        </div>
    </div>
    ...
    <a href="help.jsp" class="floating-help" data-bs-toggle="tooltip" data-bs-placement="left" title="Admin Help Center">
