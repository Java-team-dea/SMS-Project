...
<head>
    ...
    <title>Edit Grade | NSBM Green University</title>
                    ...
                    <div class="col-lg-8">
                        <div class="form-card">
                            <div class="form-header">
                                <h4><i class="fas fa-edit me-2"></i> Edit Student Grade</h4>
                            </div>
                            <div class="form-body">
                                <form action="UpdateGradeServlet" method="post">
                                    <div class="row mb-4">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="studentId" name="studentId" value="${grade.studentId}" readonly>
                                            </div>
                                            <small class="text-muted">Student identification cannot be changed</small>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="course" name="course" value="${grade.course}" readonly>
                                            </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <small class="text-muted">Enter the grade according to university grading policy (e.g., A, B+, C)</small>
                                    </div>
                                    
                                    <div class="d-flex justify-content-end gap-2 mt-4">
                                        <a href="manageGrades.jsp" class="btn btn-secondary">
