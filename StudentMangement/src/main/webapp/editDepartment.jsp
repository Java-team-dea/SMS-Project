...
<head>
    ...
    <title>Admin Portal | Edit Department</title>
                    ...
                    <a href="index.jsp" class="text-decoration-none university-brand">
                        ...
                        <div>
                            ...
                            <div class="d-flex align-items-center">
                                <p class="university-system">Administrative Management System</p>
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <small class="text-muted">Department ID cannot be modified</small>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="contact" name="contact" value="${department.contact}" required>
                                    </div>
                                </div>
                                
                                <div class="col-12 mt-4 d-flex justify-content-end gap-2">
                                    <a href="departmentList.jsp" class="btn btn-secondary">
