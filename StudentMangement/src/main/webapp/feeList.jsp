                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="fees-table">
                                    ...
                                    <tbody>
                                    <form action="FeeListServlet" method="post">
                                    ...
                                    <c:forEach var="fee" items="${feeList}">
                                        <tr>
                                            ...
                                            <td class="action-buttons">
                                               <a href="EditFeeServlet?id=${fee.record}" class="btn-action btn-edit">
                                                    <i class="fas fa-edit me-1"></i> Edit
                                                </a>
                                                <a href="deleteFee?record=${fee.record}" class="btn-action btn-delete" onclick="return confirm('Are you sure you want to delete this fee record?')">
